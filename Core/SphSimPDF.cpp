...
void SphSimPDF::Update(float dt, UINT& forceKey)
{
...
void SphSimPDF::Compute(ComPtr<ID3D12GraphicsCommandList>& commandList, bool& reset)
{
	if (reset)
	{
		reset = false;
...
void SphSimPDF::Render(ComPtr<ID3D12GraphicsCommandList>& commandList,
